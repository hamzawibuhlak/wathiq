            ...
            <div className="flex-1 flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-20 xl:px-24">
                <div className="mx-auto w-full max-w-sm lg:w-96">
                    ...
                    <div className="flex justify-center mb-8">
                        <img src="/logo.png" alt="وسم الثقة" className="h-14 w-auto object-contain" />
                    </div>
            ...
            <div className="hidden lg:block relative w-0 flex-1">
                <div className="absolute inset-0 bg-gradient-to-br from-primary via-primary/90 to-[hsl(var(--gold))]">
                    ...
                    <div className="relative h-full flex flex-col items-center justify-center p-12 text-white">
                        <img src="/icon-512.png" alt="وسم الثقة" className="w-28 h-28 mb-8 drop-shadow-2xl" />
                        <h1 className="text-4xl font-bold text-center mb-4">وسم الثقة</h1>

...
const INTEGRATION_META: Record<string, {
    ...
    FACEBOOK: {
        ...
        description: 'استقبال رسائل الصفحة وربط ماسنجر',
        category: 'communication',
    },
    INSTAGRAM: {
        gradient: 'from-pink-500 to-purple-600',
        bgLight: 'bg-pink-50 border-pink-100 text-pink-700',
        settingsPath: 'settings/instagram',
        description: 'استقبال رسائل منصة الانستجرام وربط الحساب',
        category: 'communication',
    },
    TWITTER: {
        gradient: 'from-sky-400 to-sky-600',
        bgLight: 'bg-sky-50 border-sky-100 text-sky-700',
        settingsPath: 'settings/twitter',
        description: 'استقبال الرسائل من منصة تويتر (X)',
        category: 'communication',
    },
    TELEGRAM: {
        ...
        description: 'ربط البوت الخاص بتليجرام واستقبال المحادثات',
        category: 'communication',
    },
    TIKTOK: {
        gradient: 'from-zinc-800 to-zinc-950',
        bgLight: 'bg-zinc-100 border-zinc-200 text-zinc-800',
        settingsPath: 'settings/tiktok',
        description: 'ربط حساب تيك توك لدعم صندوق الرسائل',
        category: 'communication',
    },
    CALL_CENTER: {
